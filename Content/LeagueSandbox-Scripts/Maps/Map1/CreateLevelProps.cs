...
namespace MapScripts.Map1
{
    public static class CreateLevelProps
    {
        public static void CreateProps()
        {
            ...
            AddLevelProp("LevelProp_Yonkey1", "Yonkey", new Vector3(-76.0f, 94.0f, 1769.1589f), new Vector3(0.0f, 30.0f, 0.0f), new Vector3(0.0f, -11.1111f, -22.2222f), Vector3.One*5);
            ...
            AddLevelProp("LevelProp_ShopMale1", "ShopMale", new Vector3(-99.5613f, 191.4039f, 855.6632f), new Vector3(0.0f, 158.0f, 0.0f), Vector3.Zero, Vector3.One*3);
        }
    }
}
