...
namespace Spells
{
    public class KatarinaW : ISpellScript
    {
        ...
        public void OnSpellCast(Spell spell)
        {
            ...
            // W damage (TargetExecute, an OnSpellHit listener) AND cross-script reactors (KatarinaQMark
        ...
        private void TargetExecute(Spell spell, AttackableUnit target, SpellMissile swag)
        {
            var owner = spell.CastInfo.Owner;
