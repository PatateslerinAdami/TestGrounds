...
internal class AkaliMota : IBuffGameScript {
    ...
    public void OnActivate(AttackableUnit unit, Buff buff, Spell ownerSpell) {
        ...
        _spell = ownerSpell;
        _buff  = buff;
        _p = AddParticleTarget(buff.SourceUnit, unit, "akali_markOftheAssasin_marker_tar", unit, buff.Duration, bone: "C_BUFFBONE_GLB_OVERHEAD_LOC");
        _p1 = AddParticleTarget(buff.SourceUnit, unit, "akali_markOftheAssasin_marker_tar_02", unit, buff.Duration);
