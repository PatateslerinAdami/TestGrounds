...
public class EnchantedCrystalArrow : ISpellScript
{
    ...
    private void OnSpellHit(Spell spell, AttackableUnit target, SpellMissile missile)
    {
        ...
        SpellEffectCreate(particleName, _ashe, null, null, target.Position, target.Position, scale: 1f,
            flags: FXFlags.SimulateWhileOffScreen, fowVisibilityRadius: 10f);

        Vector2 castPosition = new Vector2(spell.CastInfo.SpellCastLaunchPosition.X,
        ...
        target.TakeDamage(_ashe, dmg, DamageType.DAMAGE_TYPE_MAGICAL, DamageSource.DAMAGE_SOURCE_SPELLAOE,
            DamageResultType.RESULT_NORMAL);


        var units = GetUnitsInRange(_ashe, target.Position, 400, true,
        ...
        foreach (var unit in units)
        {
            ...
            unit.TakeDamage(_ashe, dmg * 0.5f, DamageType.DAMAGE_TYPE_MAGICAL, DamageSource.DAMAGE_SOURCE_SPELLAOE,
                DamageResultType.RESULT_NORMAL);
        }
