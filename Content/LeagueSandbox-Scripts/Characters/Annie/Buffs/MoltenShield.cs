...
internal class MoltenShield : IBuffGameScript {
    ...
    public void OnActivate(AttackableUnit unit, Buff buff, Spell ownerSpell) {
        ...
        ApiEventManager.OnPreTakeDamage.AddListener(this, unit, OnBeingHit);
    }
    ...
    private void OnBeingHit(DamageData data) {
        if (!IsValidTarget(_annie, data.Target,
        ...
        AddParticleTarget(_annie, null, "AnnieSparks", data.Attacker);
