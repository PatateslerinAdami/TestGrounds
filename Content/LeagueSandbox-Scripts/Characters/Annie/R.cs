...
public class InfernalGuardian : ISpellScript {
    ...
    public void OnSpellPostCast(Spell spell) {
        ...
        SpellEffectCreate(particleName, _annie, null, null, tibbers.Position, targetPos: tibbers.Position, scale: 1f, flags: FXFlags.SimulateWhileOffScreen, fowVisibilityRadius: 10f);
