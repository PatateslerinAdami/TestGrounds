...
public class ItemID_3713 : IItemScript {
    ...
    public void OnActivate(ObjAIBase owner) {
        ...
        owner.SetSpell("ItemSmiteAoE", owner.GetSpell("SummonerSmite").CastInfo.SpellSlot, true);
    }
    ...
    public void OnDeactivate(ObjAIBase owner) {
        owner.SetSpell("SummonerSmite", owner.GetSpell("ItemSmiteAoE").CastInfo.SpellSlot, true);
    }
}