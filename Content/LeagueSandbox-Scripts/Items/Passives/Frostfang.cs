...
public class ItemID_3098 : IItemScript {
    private static long          _timer12, _timer30;
    ...
    public void OnActivate(ObjAIBase owner) {
        ...
        _timer12 = DateTimeOffset.Now.ToUnixTimeMilliseconds();
    ...
    public void OnUpdate(float diff) {
        if (_minionKilled) {
            ...
            var currentTime12 = DateTimeOffset.Now.ToUnixTimeMilliseconds();
            if (currentTime12 - _timer12 < 12000) return;
            LoggerProvider.GetLogger().Info("12 finished");
            _timer12      = currentTime12;
            _timer30      = currentTime12;
            _count        = 0;
            _minionKilled = false;
        }
    }
