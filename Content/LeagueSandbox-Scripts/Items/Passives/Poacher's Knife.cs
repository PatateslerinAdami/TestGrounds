...
public class ItemID_3711 : IItemScript {
    ...
    public void OnActivate(ObjAIBase owner) {
        ...
        owner.SetSpell("S5_SummonerSmiteQuick", owner.GetSpell("SummonerSmite").CastInfo.SpellSlot, true);
    }

    public void OnDeactivate(ObjAIBase owner) {
        owner.SetSpell("SummonerSmite", owner.GetSpell("S5_SummonerSmiteQuick").CastInfo.SpellSlot, true);
    }
