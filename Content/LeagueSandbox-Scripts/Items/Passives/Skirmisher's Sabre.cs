...
public class ItemID_3715 : IItemScript {
    ...
    public void OnActivate(ObjAIBase owner) {
        ...
        owner.SetSpell("S5_SummonerSmiteDuel", owner.GetSpell("SummonerSmite").CastInfo.SpellSlot, true);
    }
    ...
    public void OnDeactivate(ObjAIBase owner) {
        owner.SetSpell("SummonerSmite", owner.GetSpell("S5_SummonerSmiteDuel").CastInfo.SpellSlot, true);
    }
}