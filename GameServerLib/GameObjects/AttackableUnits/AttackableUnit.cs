...
namespace LeagueSandbox.GameServer.GameObjects.AttackableUnits
{
    ...
    public class AttackableUnit : GameObject
    {
        ...
        internal bool InHardCollision { get => _inHardCollision; set => _inHardCollision = value; }
        internal bool InBodyContact { get => _inBodyContact; set => _inBodyContact = value; }
        internal int StuckGhostFrames { get => _stuckGhostFrames; set => _stuckGhostFrames = value; }
