...
namespace LeagueSandbox.GameServer.API
{
    public static class ApiMapFunctionManager
    {
        ...
        public static LaneMinion CreateLaneMinion(List<MinionSpawnType> list, Vector2 position, TeamId team, int minionNo, string barracksName, List<Vector2> waypoints, string laneMinionAI)
        {
        ...
        public static Minion CreateMinion(
            ...
            int healthBonus = 0, int initialLevel = 1, Vector3 direction = default)
        {
            var m = new Minion(_game, owner, position, model, name, netId, team, skinId, ignoreCollision, isTargetable, isWard, null, null, aiScript, damageBonus, healthBonus, initialLevel, direction: direction);
            _game.ObjectManager.AddObject(m);
            return m;
        }
        ...
        public static Minion CreateMinionTemplete(
            ...
            int healthBonus = 0, int initialLevel = 1, Vector3 direction = default)
        {
            return new Minion(_game, null, position, model, name, netId, team, skinId, ignoreCollision, isTargetable, isWard, null, null, aiScript, damageBonus, healthBonus, initialLevel, direction: direction);
        }
